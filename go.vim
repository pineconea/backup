...
hi def link     goDirective         Constant 
hi def link     goDeclaration       Constant
hi def link     goDeclType         	Constant 
...
hi def link     goStatement         Constant
hi def link     goConditional      	Constant 
hi def link     goLabel            	Constant 
hi def link     goRepeat           	Constant 
...
hi def link     goConstants        	Identifier 
...
hi def link     goComment          	Identifier 
...
hi def link     goString            MoreMsg 
hi def link     goRawString         MoreMsg 
